...
from trackron.utils.misc import jpeg4py_loader_w_failsafe
import torch
from collections import OrderedDict
import os
from scipy.io import loadmat
from trackron.data.bounding_box_utils import masks_to_bboxes
...
class SBD(BaseImageDataset):
    ...
    """
    def __init__(self, root, image_loader=jpeg4py_loader_w_failsafe, data_fraction=None, split="train"):
        """
        args:
