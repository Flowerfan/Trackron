...
class FeaturePyramidNetworkNorm(nn.Module):
    """
    ...
    def __init__(
        ...
        super(FeaturePyramidNetworkNorm, self).__init__()
    ...
    def forward(self, x: Dict[str, Tensor], use_norm_layer: bool=False) -> Dict[str, Tensor]:
        """
        ...
        if self.norm is not None:
            results = [self.norm(result) for result in results]
